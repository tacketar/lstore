...
IBPS_API int handle_transfer(ibp_task_t *task, osd_id_t rpid, tbx_ns_t *ns, const char *key,
                             const char *typekey);
...
IBPS_API int read_from_disk(ibp_task_t *task, Allocation_t *a, ibp_off_t *left,
                            Resource_t *res);
