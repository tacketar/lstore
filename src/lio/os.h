...
#define os_create_object_with_attrs(os, c, path, type, id, key, val, v_size, n_keys) (os)->create_object_with_attrs(os, c, path, type, id, key, val, v_size, n_keys)
...
#define os_get_multiple_attrs_immediate(os, c, path, keys, vals, v_sizes, n) (os)->get_multiple_attrs_immediate(os, c, path, keys, vals, v_sizes, n)
#define os_set_multiple_attrs(os, c, fd, keys, vals, v_sizes, n) (os)->set_multiple_attrs(os, c, fd, keys, vals, v_sizes, n)
#define os_set_multiple_attrs_immediate(os, c, path, keys, vals, v_sizes, n) (os)->set_multiple_attrs_immediate(os, c, path, keys, vals, v_sizes, n)
...
LIO_API int os_local_filetype_stat(const char *path, struct stat *stat_link, struct stat *stat_object);
