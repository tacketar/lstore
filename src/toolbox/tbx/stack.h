...
TBX_API int tbx_stack_link_insert_below(tbx_stack_t *stack, tbx_stack_ele_t *ele);
...
TBX_API void *tbx_stack_top_first(tbx_stack_t *stack);
TBX_API void *tbx_stack_bottom_first(tbx_stack_t *stack);
TBX_API void *tbx_stack_next_down(tbx_stack_t *stack);
TBX_API void *tbx_stack_next_up(tbx_stack_t *stack);
