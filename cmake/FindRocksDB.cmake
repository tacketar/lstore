...
if (ROCKSDB_LIBRARY AND ROCKSDB_INCLUDE_DIR)
    ...
    if (ext STREQUAL ".a")
        message(STATUS "Static version of RocksDB so checking for bzip2")
        find_library(ROCKSDB_EXTRA_LIBRARY NAMES bz2)

        if (ROCKSDB_EXTRA_LIBRARY)
           message(STATUS "Found bzip2: ${ROCKSDB_EXTRA_LIBRARY}")
        else ()
